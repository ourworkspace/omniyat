$(document).ready(function(){
	...
	p1logobgsectionheight_v = $(".section2").height();
	...
	p2logobgsectionend_v = p2bannersectionshowtextend_v + $(window).height()/2 + $(".section8").height();
	p2logobgsectionhideposition_v = p2bannersectionshowtextend_v + $(".section8").height() + $(".section8").height();
	...
	p3bannersectionzoomend_v = p2projecttransparentdatasectionzoomingtransparentimageend_v + $(".section12").height()/3 + $(".section13").height() + $(".section13").height()/2;
	p3bannersectionshowtextend_v = p3bannersectionzoomend_v + $(window).height()/2;
	p3logobgsectionend_v = p3bannersectionshowtextend_v + $(window).height()/2 + $(".section14").height();
	p3logobgsectionhideposition_v = p3bannersectionshowtextend_v + $(".section14").height() + $(".section14").height();
	...
	$(".whats-new-menu-link").click(function(){
		$("html, body").animate({ scrollTop: whatsnewsectionshowend_v });
	});
	// contact us
	$(".contactus-menu-link").click(function(){
		$("html, body").animate({ scrollTop: contactussectionshowend_v });
	});
	// portfolio
	$(".portfolio-menu-link").click(function(){
		$("html, body").animate({ scrollTop: portfoliosectionshowend_v });
	});
	// about
	$(".about-menu-link").click(function(){
		$("html, body").animate({ scrollTop: aboutbannersectionshowtextend_v });
	});
});
