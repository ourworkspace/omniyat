	function loadVariables() {
		...
		p1projecttransparentdatasectionprojectanimationdone_part_v = p1projectplacesdatasection_v + $(".section6").height();
			...
			p1projecttransparentdatasectionzoomingtransparentimageend_v = p1projecttransparentdatasectionprojectanimationdone_part_v + 200;
		...
		p2bannerhidetransitionstartposition_v = p2bannersectionshowtextend_v + $(window).height();
		p2logobgsectionhideposition_v = p2bannerhidetransitionstartposition_v + $(window).height();	/* $(".section8").height() + $(".section8").height() */
		p2logoandtextsectionend_v = p2logobgsectionhideposition_v + $(".section9").height() + $(".section10").height() + $(window).height()/2;
		p2logoandtextsectionscreenwaitingtimeend_v = p2logoandtextsectionend_v + $(window).height()/3;
		p2projectplacesdatasectionbuildingimagezoominend_v = p2logoandtextsectionscreenwaitingtimeend_v + $(window).height();
		...
		p2projectplacesdatasectionbuildingimageafterzoomouttransitionendposition_v = p2projectplacesdatasectionbuildingimageafterzoomouttransitionstartposition_v + $(window).height();
		...
		p2projecttransparentimagesectionstaticstillend_part_v = p2projecttransparantimagebuildingdatasectionendzoomintransitionposition_v;
			p2projecttransparentimagesectionstaticstillend_v = p2projecttransparentimagesectionstaticstillend_part_v;
			p2projecttransparentimagesectionslightzoominend_v = p2projecttransparentimagesectionstaticstillend_part_v + $(".section12").height() - $(".section12").height();
			p2projecttransparentimagesectionssideimagestransitionend_v = p2projecttransparentimagesectionstaticstillend_part_v + $(".section12").height() + $(".section12").height()/3 - $(".section12").height(),
		...
		p2projecttransparentdatasectionzoomingtransparentimageend_v = p2projecttransparentimagesectionsdatahidetransitionend_v - $(".section12").height() + 200;
		
		p3bannersectionzoomend_v = p2projecttransparentdatasectionzoomingtransparentimageend_v + $(".section12").height()/3 + $(".section13").height() + $(".section13").height()/2; /* + $(".section13").height() + $(".section13").height()/2 */
		...
		p3bannerhidetransitionstartposition_v = p3bannersectionshowtextend_v + $(window).height();
		p3logobgsectionhideposition_v = p3bannerhidetransitionstartposition_v + $(window).height();	/* $(".section14").height() + $(".section14").height() */
		p3logoandtextsectionend_v = p3logobgsectionhideposition_v + $(".section15").height() + $(".section16").height() + $(window).height()/2;
		p3logoandtextsectionscreenwaitingtimeend_v = p3logoandtextsectionend_v + $(window).height()/3;
		p3projectplacesdatasectionbuildingimagezoominend_v = p3logoandtextsectionscreenwaitingtimeend_v + $(window).height();
		...
		p3projectplacesdatasectionbuildingimageafterzoomouttransitionendposition_v = p3projectplacesdatasectionbuildingimageafterzoomouttransitionstartposition_v + $(window).height();
		...
		p3projecttransparentimagesectionstaticstillend_part_v = p3projecttransparantimagebuildingdatasectionendzoomintransitionposition_v;
			p3projecttransparentimagesectionstaticstillend_v = p3projecttransparentimagesectionstaticstillend_part_v;
			p3projecttransparentimagesectionslightzoominend_v = p3projecttransparentimagesectionstaticstillend_part_v + $(".section18").height() - $(".section18").height();
			p3projecttransparentimagesectionssideimagestransitionend_v = p3projecttransparentimagesectionstaticstillend_part_v + $(".section18").height() + $(".section18").height()/3 - $(".section18").height(),
		p3projecttransparentimagesectionsdatahidetransitionend_v = p3projecttransparentimagesectionssideimagestransitionend_v + $(".section18").height()/3;
		...
		aboutbannersectionzoomend_v = p3projecttransparentdatasectionzoomingtransparentimageend_v + $(".section18").height()/3 + $(".section19").height() ;
