    ...
    <div class="row">
        <div class="col-md-12 grid-margin mb-3">
            <div class="d-flex card">
                ...
                <div class="card-body">
                    <form class="row" action="{{route('csr.update')}}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" required name="date" value="{{date('m/d/Y',strtotime($csr->date))}}" class="form-control datepicker" autocomplete="off">
                            @if($errors->has('date'))
