    ...
    <!-- <div class="row page-title-header">
        <div class="col-12">
            <div class="page-header">
                <h4 class="page-title" style="white-space: nowrap;">Sponsorships List</h4>
            </div>
        </div>
    </div> -->
        ...
        <div class="col-md-12 grid-margin mb-3">
            ...
            <div class="d-flex card">
                <div class="card-header">
                    <h5 class="card-title">Sponsorships List
                        <div class="pull-right col-md-3">
                            <button><a href="{{route('sponsorships.add')}}" class="btn btn-auto tss-msb px-45 py-15 fs-12">Add Sponsorship</a></button>
                        </div>
                        <div class="pull-right col-md-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered dataTables">
                            ...
                            <tbody>
                                @foreach($sponsorshipsList as $key => $value)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <span>
                                                <a href="{{route('sponsorships.delete',['Id'=>$value->id])}}" onclick="return confirm('Do you want to delete data?')"> <i class="fa fa-trash-o fa-1x"></i> </a>
                                            </span>
                                        </td>
                                    </tr>
                                @endforeach
