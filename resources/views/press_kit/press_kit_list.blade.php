    ...
    <!-- <div class="row page-title-header">
        <div class="col-12">
            <div class="page-header">
                <h4 class="page-title" style="white-space: nowrap;">Press Kit List</h4>
            </div>
        </div>
    </div> -->
        ...
        <div class="col-md-12 grid-margin mb-3">
            ...
            <div class="d-flex card">
                <div class="card-header">
                    <h5 class="card-title">Press Kit List
                        <div class="pull-right col-md-3">
                            <button><a href="{{route('press.kit.add')}}" class="btn btn-auto tss-msb px-45 py-15 fs-12">Add Press Kit</a></button>
                        </div>
                        <div class="pull-right col-md-3">
                            ...
                            <tbody>
                                @foreach($PressKit as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <span>
                                                <a href="{{route('press.kit.edit',['Id'=>$value->id])}}"> <i class="fa fa-edit fa-1x"></i> </a>
                                            </span>
                                            <span>
                                                <a href="{{route('press.kit.delete',['Id'=>$value->id])}}" onclick="return confirm('Do you want to delete data?')"> <i class="fa fa-trash-o fa-1x"></i> </a>
                                            </span>
                                        </td>
                                    </tr>
                                @endforeach
