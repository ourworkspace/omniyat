                ...
                <form method="POST" id="floorPlanPopUp" action="javascript:0;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 px-3">
                            ...
                            <button type="submit" id="floorPlanBtn" class="btn btn-link btn-red btn-block text-uppercase tss-msb py-10 px-45 my-5 fs-14">enquire more</button>
                ...
                <form method="POST" id="contactFormSubmitPopUp" action="javascript:0;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 px-3">
                            ...
                            <button type="submit" id="contactBtnReportPopUp" class="btn btn-link btn-red btn-block text-uppercase tss-msb py-10 px-45 my-5 fs-14">enquire more</button>
