                ...
                <div class="row py-20 pt-45">
                    <div class="col-md-6">
                        <ol class="breadcrumb omniyat">
                            <li class="breadcrumb-item"><a class="white-text" href="#">Leaderships</a></li>
...
<div class="inner-page mobile_view">
        ...
        <div class="row">
            <div class="col-md-12 pb-30 px-20">
                @if(strlen($leadership_data->long_description) > 300)
                    ...
                    <div id="more_data_m" class="m_description" style="display: none">{!! $leadership_data->long_description !!}
                        <details>
                            <summary>
                            <span id="less_data_btn_m" class="tss-msb fs-14 text-black text-uppercase ">Read Less</span></summary>
                        </details>
                    </div>
                @else
  ...
  <script type="text/javascript">
      $("#more_data_btn").click(function(){
        ...
        $("#more_data_btn_m").click(function(){
            $("#more_data_m").show();
            $("#less_data_m").hide();
        });

        $("#less_data_btn_m").click(function(){
            $("#more_data_m").hide();
            $("#less_data_m").show();
        });
  </script>  
