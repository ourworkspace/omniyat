    ...
    <!-- <div class="row page-title-header">
        <div class="col-12">
            <div class="page-header">
                <h4 class="page-title" style="white-space: nowrap;">WhatsOnMedia List</h4>
            </div>
        </div>
    </div> -->
        ...
        <div class="col-md-12 grid-margin mb-3">
            <div class="d-flex card">
                <div class="card-header">
                    <h5 class="card-title">What's On Media List
                        
                        <div class="pull-right col-md-3">
                            <button><a href="{{route('whatsOnMedia.add')}}" class="btn btn-auto tss-msb px-45 py-15 fs-12">Add What's on Media</a></button>
                        </div>
                        <div class="pull-right col-md-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered dataTables">
                            ...
                            <tbody>
                                @foreach($WhatsOnMedia as $key => $value)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>
                                        ...
                                        <td>
                                            <span>
                                                <a href="{{route('whatsOnMedia.edit',['Id'=>$value->id])}}"> <i class="fa fa-edit fa-1x"></i> </a>
                                            </span>
                                            <span>
                                                <a href="{{route('whatsOnMedia.delete',['Id'=>$value->id])}}" onclick="return confirm('Do you want to delete data?')"> <i class="fa fa-trash-o fa-1x"></i> </a>
                                            </span>
                                        </td>
                                    </tr>
                                @endforeach
